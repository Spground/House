...
public class ChatPrimaryMenu extends ChatPrimaryMenuBase implements OnClickListener {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.jc_widget_chat_primary_menu, this);
        ...
        edittext_layout.setBackgroundResource(R.drawable.jc_input_bar_bg_normal);
        ...
        editText.setOnFocusChangeListener(new OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    edittext_layout.setBackgroundResource(R.drawable.jc_input_bar_bg_active);
                } else {
                    edittext_layout.setBackgroundResource(R.drawable.jc_input_bar_bg_normal);
                }
