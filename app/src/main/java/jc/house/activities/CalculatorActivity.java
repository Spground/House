...
import jc.house.R;
import jc.house.chat.widget.AlertDialog;
...
public class CalculatorActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void initView(){
        ...
        this.paymentTypeAdapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,paymentTypeList);
        ...
        this.rateDiscountAdapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,rateDiscountList);
